...
#    define CP_437_IMPLEMENTED
  ...
  const wchar_t const CP437_UNICODE_LOOKUP_TABLE[256] = {
    0x0020, 0x263A, 0x263B, 0x2665, 0x2666, 0x2662, 0x2660, 0x2022,
    0x25D8, 0x26CB, 0x25D9, 0x2642, 0x2640, 0x266A, 0x266B, 0x266C,
    0x26BA, 0x25C4, 0x2195, 0x204C, 0x00B6, 0x00A7, 0x26AC, 0x21A8,
    ...
    0x00FF, 0x00D6, 0x00DC, 0x00A2, 0x00A3, 0x00A6, 0x20A7, 0x0192,
